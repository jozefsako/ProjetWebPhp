<div class="container">
  ...
  <form action="index.php?action=eventsManagement&page=coming" method="post">
    <div class="card mt-4">
              ...
              <ul class="list-group" >
                <?php foreach ($tab_events as $i => $event) { ?>
                  <?php if($event->id() == $selected_event_id){?>
                    <input class="list-group-item" style="text-align: left; font-size: 15px; color: white; background-color:rgba(28, 29, 32, 0.93);" type="submit" name="event_i" value="<?php echo $event->id(); echo' - ';echo $event->title() ?>"/>
                  <?php }else{ ?>
                    <input class="list-group-item" style="text-align: left; font-size: 15px;" type="submit" name="event_i" value="<?php echo $event->id(); echo' - ';echo $event->title() ?>"/>
                  <?php } ?>
                <?php }?>
              </ul>
            </div>
          ...
          <div class="card-body">
            ...
            <form action="index.php?action=eventsManagement&page=coming" method="post">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="title" value="<?php echo $selected_event->html_title() ?>" placeholder="Entrez ici le nom de l'évènement"/>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="start_date"  value="<?php echo $selected_event->html_start(); ?>" placeholder="Entrez ici la date de début de l'évènement"/>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="end_date" value="<?php echo $selected_event->html_end(); ?>" placeholder="Entrez ici la date de fin de l'évènement"/>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col">
                  <input type="text" class="form-control" name="lng_event" value="<?php echo $selected_event->html_lng(); ?>" placeholder="Entrez ici la longitude"/>
                </div>
                <div class="col">
                  <input type="text" class="form-control" name="lat_event" value="<?php echo $selected_event->html_lat(); ?>" placeholder="Entrez ici la latitude"/>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="url" value="<?php echo $selected_event->html_url(); ?>" placeholder="Entrez ici l'URL de l'évènement"/>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="picture" value="<?php echo $selected_event->html_picture(); ?>" placeholder="Entrez ici l'URL de l'évènement"/>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="cost" value="<?php echo $selected_event->html_cost(); ?>" placeholder="Entrez ici le Coût Approximatif de l'évènement">
                </div>
              </div>
